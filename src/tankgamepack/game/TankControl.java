...
public class TankControl implements KeyListener {
    ...
    */
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        System.out.println("Key pressed: " + KeyEvent.getKeyText(keyPressed)); // Debug statement
        if (keyPressed == up) {
    ...
    public void keyReleased(KeyEvent ke) {
        ...
        System.out.println("Key released: " + KeyEvent.getKeyText(keyReleased)); // Debug statement
        if (keyReleased == up) {
